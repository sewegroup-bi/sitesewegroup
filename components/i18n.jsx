...
const SEWE_STRINGS = {
  ...
  'foot.meta':       { pt: 'PROVEDOR OFICIAL META', en: 'OFFICIAL META PROVIDER', es: 'PROVEEDOR OFICIAL META' },
  'foot.metaFull':   { pt: 'Empresa certificada oficialmente pela Meta para desenvolver e integrar soluções de automação e comunicação, como as APIs do WhatsApp Business, com segurança e estabilidade.',
                       en: 'A company officially certified by Meta to develop and integrate automation and communication solutions, such as the WhatsApp Business APIs, with security and stability.',
                       es: 'Empresa certificada oficialmente por Meta para desarrollar e integrar soluciones de automatización y comunicación, como las APIs de WhatsApp Business, con seguridad y estabilidad.' },
